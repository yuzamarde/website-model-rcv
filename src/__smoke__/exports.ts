...
const subpaths = [
    ...
    { subpath: './schemas/portfolio', mustHave: ['PortfolioSchema', 'PortfolioItemSchema', 'PortfolioCategorySchema', 'PortfolioImageBlockSchema', 'PortfolioDescriptionBlockSchema', 'PortfolioContentBlockSchema', 'PortfolioListItemSchema', 'PortfolioListSchema', 'PortfolioListMetaSchema', 'PortfolioListEnvelopeSchema', 'PORTFOLIO_STATUS_VALUES', 'PORTFOLIO_VISIBILITY_VALUES', 'PORTFOLIO_BLOCK_TYPES', 'PORTFOLIO_EXAMPLE', 'PORTFOLIO_LIST_EXAMPLE', 'PORTFOLIO_LIST_ENVELOPE_EXAMPLE'] },
...
const rootMustHave = [
    ...
    'PortfolioSchema', 'PortfolioItemSchema', 'PortfolioCategorySchema', 'PortfolioImageBlockSchema', 'PortfolioDescriptionBlockSchema', 'PortfolioContentBlockSchema', 'PortfolioListItemSchema', 'PortfolioListSchema', 'PortfolioListMetaSchema', 'PortfolioListEnvelopeSchema', 'PORTFOLIO_STATUS_VALUES', 'PORTFOLIO_VISIBILITY_VALUES', 'PORTFOLIO_BLOCK_TYPES', 'PORTFOLIO_EXAMPLE', 'PORTFOLIO_LIST_EXAMPLE', 'PORTFOLIO_LIST_ENVELOPE_EXAMPLE',
